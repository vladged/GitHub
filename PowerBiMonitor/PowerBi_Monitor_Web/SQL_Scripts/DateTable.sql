...
-- Step 1: At this point, #dim looks like this, just showing the first 5 and last 5 dates:
DECLARE @StartDate DATE = '20200101', @NumberOfYears INT = 2;
